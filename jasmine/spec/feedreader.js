    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         ...
         it('has a defined name for each feed', function() {
            allFeeds.forEach(function(feed) {
    ...
    describe('The Menu', function() {
        ...
        it('should be hidden by default', function() {
          ...
          * clicked. This test should have two expectations: does the menu display
    ...
    describe('Initial Entries', function() {
         ...
         * container. Remember, loadFeed() is asynchronous so this test will
        ...
        it('has one or more entry elements in feed container', function() {
    ...
    describe('New Feed Selection', function() {
        ...
        var nextFeed;
        // save the next loaded feed to the nextFeed variable
        beforeEach(function(done) {
            loadFeed(1, function() {
                nextFeed = $('.feed').html();
                done();
